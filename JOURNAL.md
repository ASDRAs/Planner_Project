...
- 2026-04-28: Quest Log default window now shows schedules from yesterday through D+3 only. `Detail View` opens the full quest schedule list. Validation passes (`npm run lint`, `npm run build`, `npm run test`).
