...
- 2026-04-28: Added a separate `DailyQuestPanel` above the Quest Log schedule, currently driven by today's TODO memos with progress, compact quest rows, and empty-state coverage. Validation passes (`npm run lint`, `npm run build`, `npm run test`).
